...
public final class NumberUtils {
	...
	public static String toKoreanNumber(int n, boolean isMoney, boolean allNumToKorean) {
		...
		//if allNumToKorean is false, the 'number part' will be remain a  just number.
		String[] han1 = allNumToKorean ? new String[]{ "", "1", "2", "3", "4", "5", "6", "7", "8", "9" }  : new String[]{"","일","이","삼","사","오","육","칠","팔","구"};
